  ...
  return (
    <div>
      ...
      <DataTable value={interfaces} paginator rows={10} selectionMode="single">
        ...
        <Column field="DIRECTORIO_UBICACION" header="DIRECTORIO_UBICACION" body={(row) => TruncatedCell(row.DIRECTORIO_UBICACION)}></Column>
        <Column field="ORIGEN_INTERFASE" header="ORIGEN_INTERFASE"></Column>
        <Column field="PERIODICIDAD" header="PERIODICIDAD"></Column>
        <Column field="DESCRIPCION_INTERFASE" header="DESCRIPCION_INTERFASE" body={(row) => TruncatedCell(row.DESCRIPCION_INTERFASE)}></Column>
